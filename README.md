...
![build status](https://github.com/fjwillemsen/autotuning_methodology/actions/workflows/python-package.yml/badge.svg)
...
Upon submitting a pull request, these same checks will be ran remotely. 
